...
/******/ 	return __webpack_require__(__webpack_require__.s = "./components/TemplatedFacet/src/Index.ts");
/******/ })
/************************************************************************/
/******/ ({

/***/ "./components/TemplatedFacet/src/Index.ts":
/*!************************************************!*\
  !*** ./components/TemplatedFacet/src/Index.ts ***!
  \************************************************/
...
Object.defineProperty(exports, "__esModule", { value: true });
var TemplatedFacet_1 = __webpack_require__(/*! ./TemplatedFacet */ "./components/TemplatedFacet/src/TemplatedFacet.ts");
exports.TemplatedFacet = TemplatedFacet_1.TemplatedFacet;


/***/ }),

/***/ "./components/TemplatedFacet/src/TemplatedFacet.scss":
/*!***********************************************************!*\
  !*** ./components/TemplatedFacet/src/TemplatedFacet.scss ***!
  \***********************************************************/
/*! no static exports found */
...
var content = __webpack_require__(/*! !../../../node_modules/css-loader/dist/cjs.js??ref--4-1!../../../node_modules/sass-loader/lib/loader.js!./TemplatedFacet.scss */ "./node_modules/css-loader/dist/cjs.js?!./node_modules/sass-loader/lib/loader.js!./components/TemplatedFacet/src/TemplatedFacet.scss");
...
/***/ "./components/TemplatedFacet/src/TemplatedFacet.ts":
/*!*********************************************************!*\
  !*** ./components/TemplatedFacet/src/TemplatedFacet.ts ***!
  \*********************************************************/
/*! no static exports found */
...
__webpack_require__(/*! ./TemplatedFacet.scss */ "./components/TemplatedFacet/src/TemplatedFacet.scss");
var TemplatedFacet = /** @class */ (function (_super) {
    __extends(TemplatedFacet, _super);
    /**
     ...
     */
    function TemplatedFacet(element, options, bindings) {
        var _this = _super.call(this, element, TemplatedFacet.ID, bindings) || this;
        _this.element = element;
        _this.options = options;
        _this.options = coveo_search_ui_1.ComponentOptions.initComponentOptions(element, TemplatedFacet, options);
        coveo_search_ui_1.Assert.exists(_this.options.field);
        var script = coveo_search_ui_1.$$(_this.element).find('script');
        coveo_search_ui_1.Assert.check(!!script, 'You must define a "script" tag to render each of your field value.');
        script.style.display = 'none';
        _this.template = _.template(script.innerHTML.trim());
        _this.shownElements = [];
        if (!_this.options.resultContainer) {
            _this.options.resultContainer = _this.element;
        }
    ...
    TemplatedFacet.prototype.bindEventsForEachQuery = function () {
        var _this = this;
    ...
    TemplatedFacet.prototype.handleFieldValues = function (values) {
        var _this = this;
        this.shownElements.forEach(function (shownElement) { return _this.options.resultContainer.removeChild(shownElement); });
        this.shownElements = values
            .map(function (value) { return _this.generateTemplateFromFieldValue(value); })
            .map(function (element) {
            _this.options.resultContainer.appendChild(element);
            return element;
        });
        this.element.classList.add('initialized');
    };
    TemplatedFacet.prototype.generateTemplateFromFieldValue = function (value) {
        var element = document.createElement('div');
        element.innerHTML = this.template({
            field: value,
            originalField: this.options.field
        });
        coveo_search_ui_1.Initialization.automaticallyCreateComponentsInside(element, {
            bindings: this.getBindings(),
            options: {}
        });
        return element.firstElementChild;
    };
    TemplatedFacet.ID = 'TemplatedFacet';
    TemplatedFacet.options = {
        /**
         ...
         */
        template: coveo_search_ui_1.ComponentOptions.buildSelectorOption({
            defaultFunction: function (element) { return element.firstChild; }
        }),
        /**
         * The container in which to place the resulting template evaluations.
         * By default, the current component.
         */
        resultContainer: coveo_search_ui_1.ComponentOptions.buildSelectorOption(),
        /**
         * A query override to sent alongside the facet query.
         * By default, fetches all documents (@uri)
         */
        queryOverride: coveo_search_ui_1.ComponentOptions.buildStringOption({
            defaultValue: '@uri'
        }),
        /**
         ...
         */
        sortCriteria: coveo_search_ui_1.ComponentOptions.buildCustomOption(function (value) { return value; }, {
            defaultValue: 'score'
        }),
        /**
         ...
         * By default, 5.
         */
        maximumNumberOfValues: coveo_search_ui_1.ComponentOptions.buildNumberOption({
            defaultValue: 5
        }),
        /**
         * Whether to update the values on a new query.
         */
        updateOnNewQuery: coveo_search_ui_1.ComponentOptions.buildBooleanOption({
            defaultValue: false
        })
    };
    return TemplatedFacet;
}(coveo_search_ui_1.Component));
exports.TemplatedFacet = TemplatedFacet;
coveo_search_ui_1.Initialization.registerAutoCreateComponent(TemplatedFacet);


/***/ }),

/***/ "./node_modules/css-loader/dist/cjs.js?!./node_modules/sass-loader/lib/loader.js!./components/TemplatedFacet/src/TemplatedFacet.scss":
/*!****************************************************************************************************************************************************!*\
  !*** ./node_modules/css-loader/dist/cjs.js??ref--4-1!./node_modules/sass-loader/lib/loader.js!./components/TemplatedFacet/src/TemplatedFacet.scss ***!
  \****************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
// Module
exports.push([module.i, ".CoveoTemplatedFacet:not(.initialized) {\n  display: none; }\n", "",{"version":3,"sources":["D:/GitHub/coveo-search-ui-samples/components/TemplatedFacet/src/TemplatedFacet.scss"],"names":[],"mappings":"AAAA;EACE,aAAa,EAAE","file":"TemplatedFacet.scss","sourcesContent":[".CoveoTemplatedFacet:not(.initialized) {\n  display: none; }\n"],"sourceRoot":""}]);
...
/******/ });
//# sourceMappingURL=TemplatedFacet.js.map